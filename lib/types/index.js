 ...
 */
export const SWITCH_MODE_DESCRIPTION = '切换工作方法论，用于任务性质变化时：从「只想清楚」切到「动手改」、从「摸结构」切到「下结论」。'
...
export const MODE_NAMES = ['base', 'planner', 'analyst', 'explorer', 'executor'];
/**
 ...
 */
export function foldMode(events, end = events.length) {
    let mode;
    let index = 0;
 ...
 */
export function effectiveMode(events) {
